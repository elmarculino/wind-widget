 ...
 */
class WindWidgetModern : AppWidgetProvider() {

    companion object {
        private const val ACTION_REFRESH = "com.windwidget.ACTION_REFRESH_MODERN"
        ...
        private suspend fun updateWidgetAsync(
            ...
            try {
                ...
                val refreshIntent = Intent(context, WindWidgetModern::class.java).apply {
                    action = ACTION_REFRESH
                    putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, appWidgetId)
                }
                val pendingIntent = PendingIntent.getBroadcast(
                    context, appWidgetId + 4000, refreshIntent,
